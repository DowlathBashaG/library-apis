...
public class AuthorServiceTest {
    ...
    public void getAuthor_success() throws LibraryResourceNotFoundException {
        when(authorRepository.findById(anyInt()))
                .thenReturn(LibraryApiTestUtil.createAuthoEntityOptional());
    ...
    @Test
    public void updateAuthor_success() throws LibraryResourceAlreadyExistException,
    ...
    public void searchAuthor_success_firstname_lastname(){
        List<AuthorEntity> authorEntityList = Arrays.asList(
                new AuthorEntity(TestConstants.TEST_AUTHOR_FIRST_NAME +
                        "a" , TestConstants.TEST_AUTHOR_LAST_NAME,LocalDate.now().minusYears(30),
                        Gender.Female),
                new AuthorEntity(TestConstants.TEST_AUTHOR_FIRST_NAME +
                        "b" , TestConstants.TEST_AUTHOR_LAST_NAME,LocalDate.now().minusYears(32),
                        Gender.Male)
        );

        when(authorRepository.findByFirstNameAndLastNameContaining(TestConstants.TEST_AUTHOR_FIRST_NAME,
                TestConstants.TEST_AUTHOR_LAST_NAME)).thenReturn(authorEntityList);

        List<Author> authors = authorService.searchAuthor(TestConstants.TEST_AUTHOR_FIRST_NAME,
                  TestConstants.TEST_AUTHOR_LAST_NAME,TestConstants.API_TRACE_ID);
    ...
    public void searchAuthor_success_firstname(){
        List<AuthorEntity> authorEntityList = Arrays.asList(
                ...
                new AuthorEntity(TestConstants.TEST_AUTHOR_FIRST_NAME +
                        ...
                        Gender.Male),
                new AuthorEntity(TestConstants.TEST_AUTHOR_FIRST_NAME +
                        "c" , TestConstants.TEST_AUTHOR_LAST_NAME,LocalDate.now().minusYears(34),
                        Gender.Male)
        );
        ...
        verify(authorRepository,times(1)).findByFirstNameContaining(
                TestConstants.TEST_AUTHOR_FIRST_NAME);
    ...
    public void searchAuthor_success_lastname(){
        List<AuthorEntity> authorEntityList = Arrays.asList(
                ...
                new AuthorEntity(TestConstants.TEST_AUTHOR_FIRST_NAME +
                        ...
                        Gender.Male),
                new AuthorEntity(TestConstants.TEST_AUTHOR_FIRST_NAME +
                        "d" , TestConstants.TEST_AUTHOR_LAST_NAME,LocalDate.now().minusYears(34),
                        Gender.Male)
        );
        ...
        List<Author> authors = authorService.searchAuthor("",
                TestConstants.TEST_AUTHOR_LAST_NAME,TestConstants.API_TRACE_ID);

        verify(authorRepository,times(1)).findByLastNameContaining(
    ...
    public void searchAuthor_failure(){
        when(authorRepository
                .findByFirstNameAndLastNameContaining(TestConstants.TEST_AUTHOR_FIRST_NAME,
                          TestConstants.TEST_USER_LAST_NAME)).thenReturn(Collections.emptyList());

        List<Author> authors = authorService
                .searchAuthor(TestConstants.TEST_AUTHOR_FIRST_NAME,
                        TestConstants.TEST_AUTHOR_LAST_NAME,
                        TestConstants.API_TRACE_ID);
